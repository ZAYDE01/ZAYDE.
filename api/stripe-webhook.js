...
//      FIREBASE_PROJECT_ID    = zayde-4ce71
//      FIREBASE_CLIENT_EMAIL  = (del JSON de cuenta de servicio de Firebase)
//      FIREBASE_PRIVATE_KEY   = (del mismo JSON, el bloque completo)
...
// - Si trae comillas pegadas por accidente (copiadas del archivo .json), las quita.
// - Si trae "\n" literales (dos caracteres: backslash + n, como vienen en el
//   .json), los convierte en saltos de línea reales.
// - Si ya tiene saltos de línea reales, los deja tal cual.
// Esto evita el error "DECODER routines::unsupported" que sale cuando el
// formato de la llave no es exactamente el que espera Google.
